...
import org.growhack.bank.portal.driver.techcombank.TechcombankDriver;
...
public class TechcombankTransScanner extends TransScanner {
    public static final String bankName = "TCB";

    public static Logger LOG = LoggerFactory.getLogger(TechcombankTransScanner.class);

    public TechcombankTransScanner(Configuration configuration, BankDriver bankDriver) {
        super(bankName,
                configuration, bankDriver);
    }

    public TechcombankTransScanner(Configuration configuration,
    ...
    public static void executeThread(YamlConfiguration configuration, boolean runAsThread, AdminConfig adminConfig) {
        ...
        if (jsonElement != null) {
            ...
            TechcombankDriver driver = new TechcombankDriver(configuration, account, password);
            TechcombankTransScanner scanner = new TechcombankTransScanner(configuration, driver, bankCode, adminConfig);
