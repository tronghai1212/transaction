...
import org.growhack.bank.portal.driver.shb.SHBDriver;
...
public class SHBTransScanner extends TransScanner{

    public static final String bankName = "SHB";

    public static Logger LOG = LoggerFactory.getLogger(SHBTransScanner.class);

    public SHBTransScanner(Configuration configuration, BankDriver bankDriver){
        super(bankName,
                configuration,bankDriver);
    }

    public SHBTransScanner(Configuration configuration,
    ...
    public static void executeThread(YamlConfiguration configuration, boolean runAsThread, AdminConfig adminConfig) {
        ...
        if (jsonElement != null) {
            ...
            SHBDriver driver = new SHBDriver(configuration, account, password);
            SHBTransScanner scanner = new SHBTransScanner(configuration, driver, bankCode, adminConfig);
