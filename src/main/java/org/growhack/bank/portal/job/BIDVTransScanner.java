...
import org.growhack.bank.portal.driver.bidv.BIDVDriver;
...
public class BIDVTransScanner extends TransScanner{
    public static String bankName = "BIDV";

    public static Logger LOG = LoggerFactory.getLogger(BIDVTransScanner.class);

    public BIDVTransScanner(Configuration configuration, BankDriver bankDriver){
        super(bankName,
                configuration,bankDriver);
    }

    public BIDVTransScanner(Configuration configuration,
    ...
    public static void executeThread(YamlConfiguration configuration, boolean runAsThread, AdminConfig adminConfig) {
        ...
        if (jsonElement != null) {
            ...
            BIDVDriver driver = new BIDVDriver(configuration, account, password);
            BIDVTransScanner scanner = new BIDVTransScanner(configuration, driver, bankCode, adminConfig);
