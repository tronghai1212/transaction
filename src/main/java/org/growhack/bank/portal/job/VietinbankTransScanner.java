...
import org.growhack.bank.portal.driver.vietinbank.VietinbankDriver;
...
public class VietinbankTransScanner extends TransScanner{
    public static final String bankName = "VTB";

    public static Logger LOG = LoggerFactory.getLogger(VietinbankTransScanner.class);

    public VietinbankTransScanner(Configuration configuration, BankDriver bankDriver) {
        super(bankName,
                configuration, bankDriver);
    }

    public VietinbankTransScanner(Configuration configuration,
    ...
    public static void executeThread(YamlConfiguration configuration, boolean runAsThread, AdminConfig adminConfig){
        ...
        if (jsonElement != null) {
            ...
            VietinbankDriver driver = new VietinbankDriver(configuration, account, password);
            VietinbankTransScanner scanner = new VietinbankTransScanner(configuration, driver, bankCode, adminConfig);
