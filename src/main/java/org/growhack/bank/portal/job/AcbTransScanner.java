...
import org.growhack.bank.portal.driver.acb.AcbDriver;
...
public class AcbTransScanner extends TransScanner {
    public static final String bankName = "ACB";


    public static Logger LOG = LoggerFactory.getLogger(AcbTransScanner.class);

    public AcbTransScanner(Configuration configuration, BankDriver bankDriver){
        super(bankName,
                configuration,bankDriver);
    }

    public AcbTransScanner(Configuration configuration,
    ...
    public static void executeThread(YamlConfiguration configuration, boolean runAsThread, AdminConfig adminConfig) {
        ...
        if (jsonElement != null) {
            ...
            AcbDriver driver = new AcbDriver(configuration, account, password);
            AcbTransScanner scanner = new AcbTransScanner(configuration, driver, bankCode, adminConfig);
