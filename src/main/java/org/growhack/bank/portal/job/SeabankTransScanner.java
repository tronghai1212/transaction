...
import org.growhack.bank.portal.driver.seabank.SeabankDriver;
...
public class SeabankTransScanner extends TransScanner{

    public static String bankName = "SEABANK";

    public static Logger LOG = LoggerFactory.getLogger(SeabankTransScanner.class);

    public SeabankTransScanner(Configuration configuration,
    ...
    public static void executeThread(YamlConfiguration configuration, boolean runAsThread, AdminConfig adminConfig) {
        ...
        if (jsonElement != null) {
            ...
            SeabankDriver driver = new SeabankDriver(configuration, account, password);
            SeabankTransScanner scanner = new SeabankTransScanner(configuration, driver, bankCode, adminConfig);
