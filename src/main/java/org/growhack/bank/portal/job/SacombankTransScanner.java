...
import org.growhack.bank.portal.driver.sacombank.SacombankDriver;
...
public class SacombankTransScanner extends TransScanner{
    public static String bankName = "SCB";

    public static Logger LOG = LoggerFactory.getLogger(SacombankTransScanner.class);

    public SacombankTransScanner(Configuration configuration, BankDriver bankDriver){
        super(bankName,
                configuration,bankDriver);
    }

    public SacombankTransScanner(Configuration configuration,
    ...
    public static void executeThread(YamlConfiguration configuration, boolean runAsThread, AdminConfig adminConfig) {
        ...
        if (jsonElement != null) {
            ...
            SacombankDriver driver = new SacombankDriver(configuration, account, password);
            SacombankTransScanner scanner = new SacombankTransScanner(configuration, driver, bankCode, adminConfig);
