...
import org.growhack.bank.portal.driver.mbbank.MBDriver;
...
public class MBTransScanner extends TransScanner{
    public static final String bankName = "MBBANK";

    public static Logger LOG = LoggerFactory.getLogger(MBTransScanner.class);

    public MBTransScanner(Configuration configuration, BankDriver bankDriver){
        super(bankName,
                configuration,bankDriver);
    }

    public MBTransScanner(Configuration configuration,
    ...
    public static void executeThread(YamlConfiguration configuration, boolean runAsThread, AdminConfig adminConfig) {
        ...
        if (jsonElement != null) {
            ...
            MBDriver driver = new MBDriver(configuration, account, password);
            MBTransScanner scanner = new MBTransScanner(configuration, driver, bankCode, adminConfig);
