...
import org.growhack.bank.portal.driver.vietcombank.VietcombankDriver;
...
public class VietcombankTransScanner extends TransScanner{

    public static final String bankName = "VCB";

    public static Logger LOG = LoggerFactory.getLogger(VietcombankTransScanner.class);

    public VietcombankTransScanner(Configuration configuration, BankDriver bankDriver){
        super(bankName,
                configuration,bankDriver);
    }

    public VietcombankTransScanner(Configuration configuration,
    ...
    public static void executeThread(YamlConfiguration configuration, boolean runAsThread, AdminConfig adminConfig){
        ...
        if (jsonElement != null) {
            ...
            VietcombankDriver driver = new VietcombankDriver(configuration, account, password);
            VietcombankTransScanner scanner = new VietcombankTransScanner(configuration, driver, bankCode, adminConfig);
