...
import org.growhack.bank.portal.driver.vib.VIBDriver;
...
public class VIBTransScanner extends TransScanner{

    public static final String bankName = "VIB";

    public static Logger LOG = LoggerFactory.getLogger(VIBTransScanner.class);

    public VIBTransScanner(Configuration configuration, BankDriver bankDriver){
        super(bankName,
                configuration,bankDriver);
    }

    public VIBTransScanner(Configuration configuration,
    ...
    public static void executeThread(YamlConfiguration configuration, boolean runAsThread, AdminConfig adminConfig){
        ...
        if (jsonElement != null) {
            ...
            VIBDriver driver = new VIBDriver(configuration, account, password);
            VIBTransScanner scanner = new VIBTransScanner(configuration, driver, bankCode, adminConfig);
